...
The two fixed stems are deterministic renders of the house's E–B–F-sharp–A seed. They are final material for this room, not a runtime dependency on [`the-weaving-sound`](https://github.com/frnkptrln/the-weaving-sound). That repository remains the wider SuperCollider workshop and anthology; the house remains the finished audiovisual work.
