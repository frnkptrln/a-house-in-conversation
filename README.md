...
The September V2 replacement has been withdrawn after it displaced the existing rooms' compositions, mechanisms, and shared ageing. The root experience is restored from the last pre-V2 state (`74737e9`, after #15), with the unwanted Afterimage narration still removed. [V2-KONZEPT.md](V2-KONZEPT.md) retains the direction for future work; the rejected implementation is preserved in Git history at #16. This recovery restores the earlier navigation and room entrances too; their redesign remains unfinished.
...
A 92-second browser-native sound room built from filtered air, low harmonic planes, an unstable pulse, and short glitches. The room asks for no interaction beyond time; its field opens and then fades into several seconds of visual and acoustic absence. The browser-synthesized narration and its concluding sentence have been removed.
